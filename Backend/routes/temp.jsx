        ...
        <>
          ...
          <div id='Recipe'>
            {data.length > 0 ? ( 
              ...
              <button className='adding_f' onClick={()=>{postFavorite(meal)}}><img className='heart' src={heart} alt="" />Remove from Recipe</button>
            ...
            </div><Link to='/Createrecipe'><button className='btn_recipe'>Add + </button></Link></> )
              })) : (
